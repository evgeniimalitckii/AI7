...
def predict(doc):
    ...
    left = figure(title = 'Termal Desorption Spectra', plot_height=385,# plot_width=600,
    ...
    results = column(left)
    description = column(t1,t2,t3,t4,t5,t6,right, height=385)
    resdes = row(results, description)
